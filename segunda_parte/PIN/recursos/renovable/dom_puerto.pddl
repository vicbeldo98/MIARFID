...
(define (domain puerto)
    ...
    (:functions
        ...
        (conveyor-slow-speed ?ct -conveyor)
		(conveyor-fast-speed ?ct -conveyor)
		(conveyor-slow-burn ?c - conveyor)
		(conveyor-fast-burn ?c - conveyor)
		(fuel ?c - conveyor)
		(total-fuel-used)
		(fuel-capacity ?c - conveyor)
		(refuel-rate ?c - conveyor)
    )
