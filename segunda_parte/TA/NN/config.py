...
def load_parameters():
    ...
    # Input data params
    TASK_NAME = 'europarl-clean-tok'                           # Task name.
    ...
    START_EVAL_ON_EPOCH = 9001                       # First epoch to start the model evaluation.
    ...
    # Training parameters
    MAX_EPOCH = 15                               # Stop when computed this number of epochs.
    BATCH_SIZE = 50                               # Size of each minibatch.
    N_GPUS = 0                                    # Number of GPUs to use. Only for Tensorflow backend. Each GPU will receive mini-batches of BATCH_SIZE / N_GPUS.
    ...
    PATIENCE = 100                                 # We'll stop if the val STOP_METRIC does not improve after this.
